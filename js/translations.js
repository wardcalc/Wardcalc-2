...
en:{
  ...
  badge_stu: 'BUILT BY A MEDICAL STUDENT · FOR MEDICAL STUDENTS',
  h1_main: 'Clinical Tools',
  h1_sub: 'for Ward Rounds',
...
ru:{
  ...
  badge_stu: 'СОЗДАНО СТУДЕНТОМ-МЕДИКОМ · ДЛЯ СТУДЕНТОВ',
  h1_main: 'Клинические инструменты',
  h1_sub: 'для обходов',
...
uz:{
  ...
  badge_stu: 'TIBBIYOT TALABASI TOMONIDAN · TALABALAR UCHUN',
  h1_main: 'Klinik vositalar',
  h1_sub: 'palata aylanmalari uchun',
  hero_desc: '3 tilda mnemonikaga ega 15 ta kalkulyator. Tez, bepul va qulay — bemor yotog\'i yonida kerak bo\'lgan hamma narsa.',
  stat_calc: 'KALKULYATOR',
  stat_lang: 'TIL',
  stat_free: 'BEPUL',
